    ...
    private void evaluateArmorEffects(PlayerEntity player) {
        for (Map.Entry<ArmorMaterial, StatusEffectInstance> entry : MATERIAL_TO_EFFECT_MAP.entrySet()) {
            ...
            if(hasCorrectArmorOn(mapArmorMaterial, player)) {
                ...
                ArclightMod.LOGGER.debug("MoonlightArmorItem:evaluateArmorEffects:entry: " + mapStatusEffect.shouldShowParticles());
            }
        }
        ...
        for (Map.Entry<ArmorMaterial, StatusEffectInstance> entry2: MATERIAL_TO_EFFECT_MAP2.entrySet()) {
            ...
            if(hasCorrectArmorOn(mapArmorMaterial, player)) {
                addStatusEffectForMaterial(player, mapArmorMaterial, mapStatusEffect);
                ArclightMod.LOGGER.debug("MoonlightArmorItem:evaluateArmorEffects:entry2: " + mapStatusEffect.shouldShowParticles());
            }
        }
    }
